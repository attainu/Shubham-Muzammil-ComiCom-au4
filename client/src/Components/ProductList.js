                        ...
                        <div className="my-5">
                            <div className="row">
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <div className="item text-center">
                                        <div className="product-image">
                                            <img src="https://res.cloudinary.com/comicom/image/upload/v1585807052/Hulk/clean_yb0ud0.jpg" alt="comic" />
                                        ...
                                        <ul className="price list-inline">
                                            <li className="list-inline-item"> <span className="price-old">$1,299</span></li>
                                            <li className="list-inline-item"> <span className="price-new">$700</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <div className="item text-center">
                                        <div className="product-image">
                                            <span className="new badge badge-pill badge-info text-uppercase">new</span>
                                            <img src="https://res.cloudinary.com/comicom/image/upload/v1585807052/Hulk/clean_yb0ud0.jpg" alt="comic" />
                                            <div className="overlay">
                                                <a href='/s' className="wishlist"><FontAwesomeIcon icon={faHeart} style={{color:"#000"}}/></a>
                                                <ul className="list-unstyled">
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <div className="item text-center">
                                        <div className="product-image">
                                            <span className="sale badge badge-pill badge-primary text-uppercase">sale</span>
                                            <img src="https://res.cloudinary.com/comicom/image/upload/v1585807052/Hulk/clean_yb0ud0.jpg" alt="comic" />
                                            <div className="overlay"> <a href='/s' className="wishlist"><FontAwesomeIcon icon={faHeart} style={{color:"#000"}}/></a>
                                                <ul className="list-unstyled">
                                                    <li><a href="detail.html" className="btn btn-unique">View Detail</a></li>
                                                    <li><a href='/s' className="btn btn-dark">Add To Cart</a></li>
                                                </ul>
